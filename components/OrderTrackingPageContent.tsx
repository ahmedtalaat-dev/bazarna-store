    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-blue-50 rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-blue-600">{order.estimatedDelivery}</p>
              </div>

              {/* Items count */}
              <div>
                <p className="text-sm text-gray-600">Items</p>
                <p className="font-semibold text-blue-600">{order.items.length}</p>
              </div>
          ...
          {/* Timeline */}
          <div className="mb-12">
            <h3 className="text-xl font-bold text-blue-600 mb-8">Delivery Status</h3>
